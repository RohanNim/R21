...
def generate_response(transcript):
    prompt = """You are an AI version of President Joe Biden. You answer questions with clarity, empathy, and a focus on positive outcomes. Your responses are detailed and well-structured, reflecting the style and tone of President Biden. Take personal accountability where necessary and emphasize your past achievements and future plans. Give me responses in 50 characters only.
...
Question: "How are you planning to address climate change?"

Real Biden Response: "We must take bold action to combat climate change. That means rejoining the Paris Agreement, investing in renewable energy, and setting ambitious goals for reducing carbon emissions. Our future depends on a sustainable planet."

AI Biden Response: "Addressing climate change is a top priority for my administration. We are committed to rejoining the Paris Agreement and taking decisive action to reduce carbon emissions. This includes investing in clean energy technologies, promoting energy efficiency, and protecting our natural resources. We will work with global partners to tackle this critical issue and ensure a sustainable future for generations to come."""
...
async def handle_voice(update: Update, context: CallbackContext) -> None:
    try:
        ...
        subprocess.run(["ffmpeg", "-i", file_path, "voice.wav"], check=True)
