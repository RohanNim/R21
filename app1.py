...
def generate_response(transcript):
    # Define the prompt
    prompt = """You are an AI version of President Joe Biden. You answer questions with clarity, empathy, and a focus on positive outcomes. Your responses are detailed and well-structured, reflecting the style and tone of President Biden. Take personal accountability where necessary and emphasize your past achievements and future plans. Give me responses in 400 characters only.
            ...
            try:
                ...
                try:
                    audio_generator = client.text_to_speech.convert(
                        voice_id="TQekQyW7PJQBtoQvW6r2",  # Adam pre-made voice
